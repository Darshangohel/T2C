        ...
        <div className="flex h-full">
            ...
            <div className={`xl:w-10/12 lg:w-9/12 md:w-9/12 sm:w-full flex transition-all duration-300 ease-in-out z-10 flex-col ${isVisibleMobileNav ? 'translate-x-4/12 md:translate-x-0' : ''} ${isVisibleFilter ? 'xl:translate-x-px lg:translate-x-px md:translate-x-px sm:translate-x-px' : ''}`}>
                ...
                <div className="grow overflow-auto bg-slate-100 p-4 relative">
                    ...
                    <div className="flex -mt-13 flex-col md:flex-row justify-between rounded-md shadow-[0_0_25px_rgba(0,0,0,0.25)] bg-white py-5 px-3 text-black relative z-20">
                    ...
                    <div className="mt-5">
                        ...
                        <div className="flex">
                            ...
                            {isVisibleFilter && (
                                <div className={`${filterPopup ? 'md:z-40 md:fixed md:w-7/12 sm:w-9/12 lg:w-2/5 top-1/2 left-1/2 translate-x-[-50%] translate-y-[-50%] h-full sm:h-[75vh]' : 'md:z-0 md:static md:bg-transparent bg-gray-100 top-0 left-0 h-full md:h-auto '} md:overflow-hidden xl:w-3/12 md:w-4/12 fixed w-full z-20 pb-15 pt-11 md:pt-0 md:pb-0 overflow-x-auto rounded-md`}>
                                    <div className={`border border-gray-100 rounded-md bg-white px-4 py-3 pt-0 md:pt-3 overflow-hidden ${filterPopup ? 'flex flex-col h-full' : ''}`}>
                                        ...
                                        <div className={`-mx-4 px-4 -mb-4 pb-4 ${filterPopup ? 'grow overflow-y-auto' : ''}`}>
                                            <div className="md:hidden block">
                                                <label htmlFor="sort-by-filter" className="pt-2 text-gray-900 block pb-1">Sort By</label>
                                                <div className="relative">
                                                    <select name="sort-by-filter" id='sort-by-filter' value={sortValue} onChange={handleSortChange} className="border border-gray-400 p-2 pr-6 rounded-sm appearance-none w-full">
                                                        <option value="price-low-high">Price : Low to High</option>
                                                        <option value="price-high-low">Price : High to Low</option>
                                                        <option value="star-rating">Star Rating</option>
                                                        <option value="airport-distance">Distance from Airport</option>
